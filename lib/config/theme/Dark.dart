...
class DarkTheme {
  static ThemeData darkTheme=ThemeData(
    ...
    colorScheme: ColorScheme.fromSeed(
      ...
      onPrimaryContainer: AppColors.unselectedBookmarkAndBoarderMovieCategoryAndFilledSearchTextFieldColor,
  ...
  textTheme: TextTheme(
    displayLarge: TextsStyles.loginRegisterPrimeTitle, // for login and register yellow titles can use copyWith to control size and wight in same page
    displayMedium: TextsStyles.loginRegisterWhiteTitle, // for login and register white titles can use copyWith to control size and wight in same page
    ...
    bottomNavigationBarTheme: const BottomNavigationBarThemeData(
      ...
      unselectedIconTheme: IconThemeData(size: 25, color: AppColors.unselectedNavigatorBarIconColor),
